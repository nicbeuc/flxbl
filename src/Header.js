  ...
  return (
    <div className='Header'>
      ...
      <div className='Header__right'>
        ...
        />
        <a href='https://github.com/nicbeuc/flxbl' rel='noreferrer' target='_blank' className='Header__link'>
          <svg height='32' aria-hidden='true' viewBox='0 0 16 16' version='1.1' width='32' data-view-component='true' className='icon icon-github'>
